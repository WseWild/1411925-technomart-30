...
* Студент: [Всеволод Кучапин](https://up.htmlacademy.ru/htmlcss/30/user/1411925).
* Наставник: Дима Железцов.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1411925-technomart-30) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
